...
#include "pair_lj_cut_coul_esp_omp.h"
...
PairLJCutCoulEspOMP::PairLJCutCoulEspOMP(LAMMPS *lmp) :
  PairLJCutCoulEsp(lmp), ThrOMP(lmp, THR_PAIR)
{
...
void PairLJCutCoulEspOMP::compute(int eflag, int vflag)
{
  ev_init(eflag,vflag);
...
void PairLJCutCoulEspOMP::eval(int iifrom, int iito, ThrData * const thr)
{
...
double PairLJCutCoulEspOMP::memory_usage()
{
  double bytes = memory_usage_thr();
  bytes += PairLJCutCoulEsp::memory_usage();
